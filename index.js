...
const Exif = require('./lib/exifdata') // Location of your exif class
const exif = new Exif()
...
publik = false
prefix = '.'
fake = '*𝘽𝙤𝙩 𝘼𝙪𝙩𝙤𝙢𝙖𝙩𝙚 𝙁𝙄𝙕*'
numbernye = '0'
targetprivate = '6281220439155'
ghoibsu = 'tes'
myteks = 'okeh nyala'
blocked = []
...
function kyun(seconds) {
    ...
    const convertSticker = function(shape, author, pack, mediaData, type) {
      ...
      "author": author,
      "shape": shape,
      "api_key": "JDJiJDEwJGdFQVIxQmI3Y2h0VEtMZmV1Umg3Ry5pQ0xtV1hCSXRMdXdVUXdLS29wVFBZemEyY2VMakR1",
    };
...
client.on('message-new', async (mek) => {
	try {
		...
		const ownerNumber = ["6281220439155@s.whatsapp.net"] // ganti nomer lu
		...
		switch (command) {
			...
			case 'play':
				...
				data = await fetchJson(`https://api.vhtear.com/ytmp3?query=${args[0]}&apikey=${vhtearkey}`, {method: 'get'})
				teks = '  -「 Play Music 」-\n'
			...
			case 'ytmp3':
				...
				anu1 = await fetchJson(`https://st4rz.herokuapp.com/api/ytv?url=${args[0]}`, { method: 'get' })
				if (anu.error) return reply(anu1.error)
				teks1 = `Title : ${anu1.title}\n*Filesize* : ${anu1.filesize}`
				thumb1 = await getBuffer(anu1.thumb1)
				client.sendMessage(from, thumb, image, { quoted: mek, caption: teks })
  ...
  └─ ❏ ${prefix}cekchat
		...
		「 *𝐒𝐄𝐋𝐅𝐁𝐎𝐓 - 𝐖𝐀* 」`
			...
			case 'addsticker':
				...
				client.sendMessage(from, `𝙎𝙩𝙞𝙘𝙠𝙚𝙧 𝘿𝙞𝙨𝙞𝙢𝙥𝙖𝙣~`, MessageType.text, { quoted: mek })
				break
			case 'addvn':
				...
				client.sendMessage(from, `𝘼𝙪𝙙𝙞𝙤 𝘿𝙞𝙨𝙞𝙢𝙥𝙖𝙣~`, MessageType.text, { quoted: mek })
				break
			case 'getvn':
			...
			case 'addvideo':
				...
				client.sendMessage(from, `𝙑𝙞𝙙𝙚𝙤 𝘿𝙞𝙨𝙞𝙢𝙥𝙖𝙣~`, MessageType.text, { quoted: mek })
				break
			case 'getvideo':
				namastc = body.slice(10)
			...
			case 'ping':
				...
				exec(`neofetch --stdout`, (error, stdout, stderr) => {
					...
					client.sendMessage(from, `${teks}*Speed: ${latensi.toFixed(4)} Second*`, text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "*𝐒𝐄𝐋𝐅𝐁𝐎𝐓 - 𝐅𝐈𝐙*", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": "", "scansSidecar": "1W0XhfaAcDwc7xh1R8lca6Qg/1bB4naFCSngM2LKO2NoP5RI7K+zLw==" } } } })
